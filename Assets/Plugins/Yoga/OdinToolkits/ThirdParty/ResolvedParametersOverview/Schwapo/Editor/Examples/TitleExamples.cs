...
namespace YOGA.Modules.OdinToolkits.Schwapo.Editor.Examples
{
    ...
    public class TitleExamples_Title
    {
        ...
        [FoldoutGroup("Attribute Expression Example")] [Title("@UseAlternativeTitle ? AlternativeTitle : Title")]
        public string AttributeExpressionExample;

        [FoldoutGroup("Field Name Example")] [Title("$Title")]
        public string FieldNameExample;

        [FoldoutGroup("Method Name Example")] [Title("$GetTitle")]
        public string MethodNameExample;

        [FoldoutGroup("Property Name Example")] [Title("$TitleProperty")]
    ...
    public class TitleExamples_Subtitle
    {
        ...
        [FoldoutGroup("Field Name Example")] [Title("Title", "$Subtitle")]
        public string FieldNameExample;

        [FoldoutGroup("Method Name Example")] [Title("Title", "$GetSubtitle")]
        public string MethodNameExample;

        [FoldoutGroup("Property Name Example")] [Title("Title", "$SubtitleProperty")]
        public string PropertyNameExample;
