...
namespace YOGA.OdinToolkits.AnalysisManual.OdinAttributes.Editor
{
    ...
    {
        protected override string SetHeader() => "AssetSelector";

        protected override string SetBrief() => "可以作用于单个字段或者列表，在字段选择框旁边增加一个小按钮，可以弹出一个下拉选择框";
        ...
        protected override string SetOriginalCode() => ReadCodeWithoutNamespace(typeof(AssetSelectorExample));
    }
}