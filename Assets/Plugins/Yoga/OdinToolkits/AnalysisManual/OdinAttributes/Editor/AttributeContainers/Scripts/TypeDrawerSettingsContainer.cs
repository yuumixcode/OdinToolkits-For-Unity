...
namespace YOGA.OdinToolkits.AnalysisManual.OdinAttributes.Editor
{
    ...
    {
        protected override string SetHeader() => "TypeDrawerSettings";

        protected override string SetBrief() => "设置 Type 类型的绘制样式";
        ...
        protected override string SetOriginalCode() => ReadCodeWithoutNamespace(typeof(TypeDrawerSettingsExample));
    }
}