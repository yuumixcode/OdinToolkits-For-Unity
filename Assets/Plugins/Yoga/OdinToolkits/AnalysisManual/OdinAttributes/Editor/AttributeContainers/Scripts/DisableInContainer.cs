...
{
    public class DisableInContainer : AbsContainer
    {
        protected override string SetHeader() => "DisableIn";

        protected override string SetBrief() => "针对 Prefab 物体对象中的 Property 的 DisableIf 的特殊版本";
        ...
        protected override string SetOriginalCode() => ReadCodeWithoutNamespace(typeof(DisableInExample));
    }
}