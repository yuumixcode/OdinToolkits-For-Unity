...
{
    public class ValueDropdownContainer : AbsContainer
    {
        protected override string SetHeader() => "ValueDropdown";

        protected override string SetBrief() => "绘制一个下拉选择框，在设置值时，给定一个范围，避免出错";
        ...
        protected override List<ParamValue> SetParamValues() => new List<ParamValue>()
        {
            ...
            new ParamValue()
            {
                ...
                paramDescription = "*** 警告 *** Odin 3.3.1.11 版本中显示有问题，不推荐使用，该参数要求 ValueDropdown 作用于列表上，用于确定该列表中的元素是唯一的"
            },
            new ParamValue()
            {
                returnType = "bool",
        ...
        protected override string SetOriginalCode() => ReadCodeWithoutNamespace(typeof(ValueDropdownExample));
    }
}
