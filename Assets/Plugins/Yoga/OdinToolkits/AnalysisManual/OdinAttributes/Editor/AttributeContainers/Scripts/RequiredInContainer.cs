...
{
    public class RequiredInContainer : AbsContainer
    {
        protected override string SetHeader() => "RequiredIn";

        protected override string SetBrief() => "针对 Prefab 物体对象中的 Property 的 Required 的特殊版本，标记 Property 在某些情况下不能为空";
        ...
        protected override string SetOriginalCode() => ReadCodeWithoutNamespace(typeof(RequiredInExample));
    }
}
