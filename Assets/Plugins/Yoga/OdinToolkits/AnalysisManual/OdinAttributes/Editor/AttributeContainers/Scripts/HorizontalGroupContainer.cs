...
namespace YOGA.OdinToolkits.AnalysisManual.OdinAttributes.Editor
{
    ...
    {
        protected override string SetHeader() => "HorizontalGroup";

        protected override string SetBrief() => "控制横向的布局组，可以和其他 Group 连接使用";
        ...
        protected override string SetOriginalCode() => ReadCodeWithoutNamespace(typeof(HorizontalGroupExample));
    }
}