...
namespace YOGA.OdinToolkits.AnalysisManual.OdinAttributes.Editor
{
    ...
    [Searchable]
    public class SearchableExample : ExampleScriptableObject
    {
        ...
        [Title("FilterOptions = SearchFilterOptions.PropertyNiceName", "筛选 Name，Effects 的 NiceName 字段名，通常用于类搜索字段，列表中的元素都是一样的")]
