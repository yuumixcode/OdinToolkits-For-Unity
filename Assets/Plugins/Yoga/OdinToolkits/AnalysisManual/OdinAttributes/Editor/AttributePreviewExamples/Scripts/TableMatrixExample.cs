...
namespace YOGA.OdinToolkits.AnalysisManual.OdinAttributes.Editor
{
    ...
    public class TableMatrixExample : ExampleOdinScriptableObject
    {
        ...
        {
#if UNITY_EDITOR
            UnityEditor.EditorGUI.LabelField(rect, value);
            return value;
#endif
        }
        ...
        {
#if UNITY_EDITOR
            var guiStyle = new GUIStyle(UnityEditor.EditorStyles.centeredGreyMiniLabel)
            {
                fontSize = 14
            };
            array[x, y] = UnityEditor.EditorGUI.TextField(rect, array[x, y], guiStyle);
            return array[x, y];
#endif
        }
    }
