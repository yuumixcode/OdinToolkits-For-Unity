...
namespace YOGA.OdinToolkits.AnalysisManual.OdinAttributes.Editor
{
    ...
    public class TabGroupExample : ExampleScriptableObject
    {
        ...
        [TabGroup("useFixedHeight/GroupB", "A", useFixedHeight: true)]
        ...
        [TabGroup("icon/GroupA", "A", icon: SdfIconType.Image, TextColor = "lightorange")]
        public string tabGroup6 = "TabGroup6";

        [PropertyOrder(10)]
        [TabGroup("icon/GroupA", "B", icon: SdfIconType.Apple, TextColor = "lightgray")]
