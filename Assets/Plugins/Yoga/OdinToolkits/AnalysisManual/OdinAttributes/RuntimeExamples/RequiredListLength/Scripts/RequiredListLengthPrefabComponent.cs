...
namespace YOGA.OdinToolkits.AnalysisManual.OdinAttributes.RuntimeExamples.RequiredListLength.Scripts
{
    public class RequiredListLengthPrefabComponent : MonoBehaviour
    {
        ...
        [RequiredListLength(fixedLength: 3, PrefabKind = PrefabKind.PrefabInstanceAndNonPrefabInstance)]
        [InfoBox("该物体是场景中的预制体或者嵌套预制体或者非预制体时，开启长度限制")]
        public List<int> list7 = new List<int>();

        [Title(nameof(PrefabKind.All))]
        [RequiredListLength(fixedLength: 3, PrefabKind = PrefabKind.All)]
