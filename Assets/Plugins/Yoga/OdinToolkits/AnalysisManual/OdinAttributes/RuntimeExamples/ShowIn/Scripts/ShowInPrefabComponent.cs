...
namespace YOGA.OdinToolkits.AnalysisManual.OdinAttributes.RuntimeExamples.ShowIn.Scripts
{
    ...
    {
        [Title("PrefabKind.InstanceInScene", "该物体是场景中的预制体时，才能看到 instanceInScene 字段")]
        [MultiLineProperty]
        ...
        [Title("PrefabKind.InstanceInPrefab", "该物体是场景中的嵌套预制体时，才能看到 instanceInPrefab 字段")]
        [MultiLineProperty]
        ...
        [Title("PrefabKind.Regular", "该物体是常规预制体资产，不是场景中的物体时，才能看到 regular 字段")]
        [MultiLineProperty]
        ...
        [Title("PrefabKind.Variant", "该物体是预制体变体资产，不是场景中的物体时，才能看到 variant 字段")]
        [MultiLineProperty]
