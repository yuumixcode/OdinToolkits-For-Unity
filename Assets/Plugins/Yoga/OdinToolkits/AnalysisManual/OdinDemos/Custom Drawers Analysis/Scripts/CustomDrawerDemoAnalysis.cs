...
namespace YOGA.OdinToolkits.AnalysisManual.OdinDemos.Custom_Drawers_Analysis.Scripts
{
    ...
    public class CustomStructDrawer : OdinValueDrawer<MyStruct>
    {
        protected override void DrawPropertyLayout(GUIContent label)
        {
            ...
            YogaEditorGUIUtility.DrawRectOutlineWithBorder(rect, Color.red, 5);
            ...
            if (label != null)
            {
                ...
                YogaEditorGUIUtility.DrawRectOutlineWithBorder(prefixLabelRect, Color.yellow);
            ...
            YogaEditorGUIUtility.DrawRectOutlineWithBorder(rect, Color.green, 3);
            value.x = EditorGUI.Slider(rect.AlignLeft(rect.width * 0.5f), " X ", value.x, 0, 1);
            YogaEditorGUIUtility.DrawRectOutlineWithBorder(rect.AlignLeft(rect.width * 0.5f), Color.magenta, 0);
            value.y = EditorGUI.Slider(rect.AlignRight(rect.width * 0.5f), " Y ", value.y, 0, 1);
            YogaEditorGUIUtility.DrawRectOutlineWithBorder(rect.AlignRight(rect.width * 0.5f), Color.cyan, 0);
