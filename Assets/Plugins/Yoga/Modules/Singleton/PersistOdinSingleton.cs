...
{
    /// <summary>
    /// 继承了 SerializedMonoBehaviour 单例抽象类，持久化单例，在场景切换时，也会保持原来的实例，默认销毁后生成的实例
    /// </summary>
    /// <typeparam name="T">泛型参数，指定单例的类型</typeparam>
    public abstract class PersistOdinSingleton<T> : SerializedMonoBehaviour where T : PersistOdinSingleton<T>
    {
        /// <summary>
        /// 单例实例的静态存储字段。
        /// </summary>
