...
{
    public abstract class ApiBrowserTestClassBase : Object
    {
        #region 字段（Field）
        ...
        // 公共无参构造函数
        public ApiBrowserTestClassBase()
        {
            Debug.Log("Public parameterless constructor called");
        }

        // 受保护的有参构造函数
        protected ApiBrowserTestClassBase(int value)
        {
    ...
    // 实现类
    public class ApiBrowserTestClass : ApiBrowserTestClassBase
    {
        // 嵌套类
        ...
        // 运算符重载
        public static ApiBrowserTestClass operator +(ApiBrowserTestClass a, ApiBrowserTestClass b)
        {
            var result = new ApiBrowserTestClass();
