...
{
    /// <summary>
    /// 继承了 SerializedMonoBehaviour 的单例抽象类，提供非持久化单例模式。提供一个强制生成新的实例的方法
    /// </summary>
    /// <typeparam name="T">泛型参数，指定单例的类型</typeparam>
    public abstract class OdinSingletonRemoveOld<T> : SerializedMonoBehaviour
        where T : OdinSingletonRemoveOld<T>
    {
        /// <summary>
        /// 单例实例的静态存储字段。
        /// </summary>
