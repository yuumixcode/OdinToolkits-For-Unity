...
namespace Yuumix.OdinToolkits.Modules.Odin.Customs.Runtime.Attributes
{
    ...
    public partial class LanguageTextAttribute : Attribute
    {
        /// <summary>
        /// 英语文本
        /// </summary>
        ...
        public LanguageTextAttribute(string simplifiedChinese, string english)
        {
            SimplifiedChineseText = simplifiedChinese;
            EnglishText = english;
        }

        public LanguageTextAttribute(string simplifiedChinese, string english, bool nicifyText)
        {
            SimplifiedChineseText = simplifiedChinese;
            EnglishText = english;
    ...
    public partial class LanguageTextAttribute
    {
        // 使用 partial 扩展多语言
    }
}
