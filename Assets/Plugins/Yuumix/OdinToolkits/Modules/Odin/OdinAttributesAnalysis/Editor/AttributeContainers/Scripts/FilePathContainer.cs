...
namespace Yuumix.OdinToolkits.Modules.Odin.OdinAttributesAnalysis.Editor.AttributeContainers.Scripts
{
    ...
    {
        protected override string SetHeader() => "FilePath";

        protected override string SetBrief() => "将 string 类型 Property 绘制成一个文件路径读取器";
        ...
        protected override string SetOriginalCode() => ReadCodeWithoutNamespace(typeof(FilePathExample));
    }
}
