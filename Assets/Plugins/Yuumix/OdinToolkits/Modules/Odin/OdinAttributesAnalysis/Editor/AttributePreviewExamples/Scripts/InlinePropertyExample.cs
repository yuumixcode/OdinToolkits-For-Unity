...
namespace Plugins.YOGA.OdinToolkits.Modules.OdinAttributesAnalysis.Editor.AttributePreviewExamples.Scripts
{
    ...
    public class InlinePropertyExample : ExampleScriptableObject
    {
        [Title("Unity 原生绘制样式 Vector3")] public Vector3 vector3;

        [Title("自定义结构体 [InlineProperty] 作用于特定字段")] [InfoBox("自定义类不使用 [InlineProperty] 时")]
        public Vector2Int myVector2Int;

        [InfoBox("使用 [InlineProperty] ")] [InlineProperty]
