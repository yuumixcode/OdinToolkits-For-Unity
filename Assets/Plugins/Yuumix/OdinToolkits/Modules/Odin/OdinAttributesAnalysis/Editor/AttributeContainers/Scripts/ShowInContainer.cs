...
namespace Yuumix.OdinToolkits.Modules.Odin.OdinAttributesAnalysis.Editor.AttributeContainers.Scripts
{
    ...
    {
        protected override string SetHeader() => "ShowIn";

        protected override string SetBrief() => "针对 Prefab 物体对象中的 Property 的 ShowIf 的特殊版本";
        ...
        protected override string SetOriginalCode() => ReadCodeWithoutNamespace(typeof(ShowInExample));
    }
}
