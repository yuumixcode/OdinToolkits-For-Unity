...
namespace Yuumix.OdinToolkits.Modules.Odin.OdinAttributesAnalysis.Editor.AttributeContainers.Scripts
{
    ...
    {
        protected override string SetHeader() => "PolymorphicDrawerSettings";

        protected override string SetBrief() => "设置多态字段的绘制样式";
        ...
        protected override string SetOriginalCode() => ReadCodeWithoutNamespace(typeof(PolymorphicDrawerSettingsExample));
    }
}
