...
{
    public class HideInContainer : AbsContainer
    {
        protected override string SetHeader() => "HideIn";

        protected override string SetBrief() => "针对 Prefab 物体对象中的 Property 的 HideIf 的特殊版本";
        ...
        protected override string SetOriginalCode() => ReadCodeWithoutNamespace(typeof(HideInExample));
    }
}
