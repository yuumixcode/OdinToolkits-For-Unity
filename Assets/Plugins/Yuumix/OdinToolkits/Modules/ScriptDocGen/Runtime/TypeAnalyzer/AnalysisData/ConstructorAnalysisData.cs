...
{
    [Serializable]
    public class ConstructorAnalysisData : MemberAnalysisData
    {
        public string parametersString;

        public static ConstructorAnalysisData CreateFromConstructorInfo(ConstructorInfo constructorInfo,
            Type type)
        {
