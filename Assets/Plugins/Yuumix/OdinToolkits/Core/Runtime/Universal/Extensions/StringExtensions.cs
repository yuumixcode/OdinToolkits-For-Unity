...
namespace Yuumix.OdinToolkits.Core.Runtime
{
    ...
    /// </summary>
    /// <remarks></remarks>
    [BilingualComment("字符串静态扩展类，提供丰富的字符串处理功能", "The Static Extensions For string, provide many features")]
    public static class StringExtensions
    {
        ...
        [BilingualComment("将字符串中的特定文本替换为带颜色的富文本格式（Unity 富文本）",
        ...
        [BilingualComment("将字符串转换为Unity富文本格式的红色文本", "Converts the string to Unity rich text format in red")]
        ...
        [BilingualComment("将字符串转换为Unity富文本格式的绿色文本", "Converts the string to Unity rich text format in green")]
        ...
        [BilingualComment("将字符串转换为Unity富文本格式的蓝色文本", "Converts the string to Unity rich text format in blue")]
        ...
        [BilingualComment("将字符串转换为Unity富文本格式的黄色文本", "Converts the string to Unity rich text format in yellow")]
        ...
        [BilingualComment("将字符串转换为Unity富文本格式的橙色文本", "Converts the string to Unity rich text format in orange")]
        ...
        [BilingualComment("将字符串转换为Unity富文本格式的紫色文本", "Converts the string to Unity rich text format in purple")]
        ...
        [BilingualComment("将字符串转换为Unity富文本格式的粉色文本", "Converts the string to Unity rich text format in pink")]
        ...
        [BilingualComment("将字符串转换为Unity富文本格式的棕色文本", "Converts the string to Unity rich text format in brown")]
        ...
        [BilingualComment("将字符串转换为Unity富文本格式的灰色文本", "Converts the string to Unity rich text format in gray")]
        ...
        [BilingualComment("将字符串转换为Unity富文本格式的黑色文本", "Converts the string to Unity rich text format in black")]
        ...
        [BilingualComment("将字符串转换为Unity富文本格式的银色文本", "Converts the string to Unity rich text format in silver")]
        ...
        [BilingualComment("将字符串转换为Unity富文本格式的青色文本", "Converts the string to Unity rich text format in cyan")]
        ...
        [BilingualComment("将字符串转换为Unity富文本格式的亮绿色文本", "Converts the string to Unity rich text format in lime")]
        ...
        [BilingualComment("将字符串转换为Unity富文本格式的深绿色文本", "Converts the string to Unity rich text format in dark green")]
        ...
        [BilingualComment("将字符串转换为Unity富文本格式的深红色文本", "Converts the string to Unity rich text format in dark red")]
        ...
        [BilingualComment("将字符串记录到调试控制台窗口", "Logs the string to the debug console window")]
        ...
        [BilingualComment("判断字符串是否为空、null或仅包含空白字符",
        ...
        [BilingualComment("判断字符串是否为空或null", "Determines whether the string is null or empty")]
        ...
        [BilingualComment("安全地截取字符串，防止越界异常", "Safely truncates the string to prevent out-of-bounds exceptions")]
        ...
        [BilingualComment("计算字符串的MD5哈希值", "Calculates the MD5 hash of the string")]
        ...
        [BilingualComment("将字符串转换为标题格式（每个单词首字母大写）",
        ...
        [BilingualComment("反转字符串中的字符顺序", "Reverses the order of characters in the string")]
        ...
        [BilingualComment("移除字符串中的所有HTML标签", "Removes all HTML tags from the string")]
        ...
        [BilingualComment("统计字符串中特定字符的出现次数",
            "Counts the number of occurrences of a specific character in the string")]
        ...
        [BilingualComment("确保字符串以指定的后缀结尾", "Ensures the string ends with the specified suffix")]
        ...
        [BilingualComment("确保字符串以指定的前缀开始", "Ensures the string starts with the specified prefix")]
        ...
        [BilingualComment("安全地将字符串转换为整数，转换失败时返回默认值",
        ...
        [BilingualComment("将字符串中的换行符替换为HTML的br标签", "Replaces newline characters with HTML br tags")]
        ...
        [BilingualComment("从字符串中提取所有URL", "Extracts all URLs from the string")]
        ...
        [BilingualComment("将字符串转换为Base64编码", "Converts the string to Base64 encoding")]
        ...
        [BilingualComment("从Base64编码的字符串还原为原始字符串", "Decodes a Base64 encoded string back to its original form")]
