...
{
    [MultiLanguageComment("访问修饰符类型枚举", "Access modifier type enumeration")]
    ...
    [MultiLanguageComment("反射工具类", "Reflection utility class")]
    public static class ReflectionUtil
    {
        [MultiLanguageComment("自定义成员类型映射字典", "Custom member type mapping dictionary")]
        ...
        [MultiLanguageComment("根据部分程序集名称获取程序集数组", "Get an array of assemblies based on a partial assembly name")]
        ...
        [MultiLanguageComment("获取程序集中的命名空间列表", "Get a list of namespaces in an assembly")]
        ...
        [MultiLanguageComment("获取访问修饰符的字符串表示", "Get the string representation of an access modifier")]
