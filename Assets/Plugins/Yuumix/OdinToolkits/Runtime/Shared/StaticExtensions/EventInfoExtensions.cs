...
namespace Yuumix.OdinToolkits.Shared
{
    ...
    {
        [MultiLanguageComment("获取事件的访问修饰符类型", "Get the access modifier type of an event")]
        ...
        [MultiLanguageComment("获取事件的可读返回类型", "Get the readable return type of an event")]
        ...
        [MultiLanguageComment("判断事件是否为静态事件", "Determine if an event is a static event")]
