...
namespace Yuumix.OdinToolkits.Core
{
    ...
    [MultiLanguageComment("多语言 InfoBox 特性", "Multi-language InfoBox")]
    public class MultiLanguageInfoBoxAttribute : Attribute
    {
        ...
        public MultiLanguageInfoBoxAttribute(string chinese, string english = null,
