...
namespace Yuumix.OdinToolkits.Core
{
    ...
    public class YuumixLoggerSetting : IOdinToolkitsReset
    {
        ...
        [PropertyOrder(0)]
        [OnInspectorGUI]
        [MultiLanguageTitle("Yuumix Logger 设置", "Yuumix Logger Setting", beforeSpace: false)]
        public void Title1() { }

        [PropertyOrder(10)]
        [MultiLanguageText("允许输出的 LogTag 设置", "LogTag List which are allowed Log")]
        [AssetList]
        ...
        [PropertyOrder(20)]
        [FolderPath]
        [MultiLanguageText("编辑器阶段日志保存路径", "EditorLogSavePath")]
        ...
        [ReadOnly]
        [LabelWidth(170)]
        [MultiLanguageText("运行时阶段日志保存路径", "RuntimeLogSavePath")]
