...
{
    public class EnableInContainer : AbsContainer
    {
        protected override string SetHeader() => "EnableIn";

        protected override string SetBrief() => "针对 Prefab 物体对象中的 Property 的 EnableIf 的特殊版本";
        ...
        protected override string SetOriginalCode() => ReadCodeWithoutNamespace(typeof(EnableInExample));
    }
}
