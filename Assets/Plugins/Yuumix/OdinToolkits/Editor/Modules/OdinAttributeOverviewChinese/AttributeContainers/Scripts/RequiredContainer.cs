...
namespace Yuumix.OdinToolkits.Modules.Odin.OdinAttributesAnalysis.Editor.AttributeContainers.Scripts
{
    ...
    {
        protected override string SetHeader() => "Required";

        protected override string SetBrief() => "要求字段不能为空，否则发出错误提示";
        ...
        protected override string SetOriginalCode() => ReadCodeWithoutNamespace(typeof(RequiredExample));
    }
}
