...
namespace Yuumix.OdinToolkits.Modules.Odin.OdinAttributesAnalysis.Editor.Window
{
    public class ChineseAttributeEditorWindow : OdinMenuEditorWindow
    {
        ...
        [MenuItem(OdinToolkitsWindowMenuItems.AttributeChineseMenuItemName, false, OdinToolkitsWindowMenuItems.AttributeChinesePriority)]
        public static void ShowWindow()
        {
            _window = GetWindow<ChineseAttributeEditorWindow>();
            _window.titleContent = new GUIContent(OdinToolkitsWindowMenuItems.AttributeChineseWindowName);
