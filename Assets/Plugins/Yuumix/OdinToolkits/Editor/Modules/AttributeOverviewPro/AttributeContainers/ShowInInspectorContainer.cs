...
{
    public class ShowInInspectorContainer : OdinAttributeContainerSO
    {
        protected override string GetHeader() => "ShowInInspector";

        protected override string GetIntroduction() => "在 Inspector 面板上显示任何成员";
