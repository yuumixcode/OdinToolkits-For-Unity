...
{
    public class ShowIfGroupContainer : OdinAttributeContainerSO
    {
        protected override string GetHeader() => "ShowIfGroup";
        ...
        protected override string GetOriginalCode() => ReadCodeWithoutNamespace(typeof(ShowIfGroupExample));
    }
}
