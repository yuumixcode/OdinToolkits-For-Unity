    ...
    public class MethodAnalysisDataFactory : IMethodAnalysisDataFactory
    {
        ...
        public MethodAnalysisData CreateFromMethodInfo(MethodInfo methodInfo, Type type)
        {
            var methodData = new MethodAnalysisData
            {
                ...
                parametersString = methodInfo.GetParametersNameWithDefaultValue(),
                isFromInterfaceImplement = methodInfo.IsFromInterfaceImplementMethod(),
            ...
            var methodName = methodInfo.GetPartMethodSignatureContainsNameAndParameters();
