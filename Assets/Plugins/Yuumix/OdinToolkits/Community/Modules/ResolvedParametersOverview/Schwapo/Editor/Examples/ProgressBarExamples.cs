...
namespace Yuumix.OdinToolkits.Community.Schwapo.Editor
{
    ...
    public class ProgressBarExamples_MinGetter
    {
        ...
        [ProgressBar("@UseIncreasedMin ? IncreasedMin : Min", 10f)]
        ...
        [ProgressBar("GetMin", 10f)]
        public float MethodNameExample = 7.5f;

        public float Min = 0f;

        [FoldoutGroup("Property Name Example")]
        [ProgressBar("MinProperty", 10f)]
    ...
    {
        [FoldoutGroup("Attribute Expression Example")]
        [ProgressBar(0f, "@UseIncreasedMax ? IncreasedMax : Max")]
        public float AttributeExpressionExample = 7.5f;
        ...
        [FoldoutGroup("Method Name Example")]
        [ProgressBar(0f, "GetMax")]
        public float MethodNameExample = 7.5f;

        [FoldoutGroup("Property Name Example")]
        [ProgressBar(0f, "MaxProperty")]
        public float PropertyNameExample = 7.5f;
    ...
    public class ProgressBarExamples_ColorGetter
    {
        ...
        Color GetColor() => UseAlternativeColor ? AlternativeColor : Color;
    }
    // End
    ...
    public class ProgressBarExamples_CustomValueStringGetter
    {
        ...
        string GetValueString(float value) => "The current value is: " + value;
    }
    // End
}
