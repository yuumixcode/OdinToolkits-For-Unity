...
{
    public class DrawWithUnityContainer : OdinAttributeContainerSO
    {
        protected override string GetHeader() => "DrawWithUnity";

        protected override string GetIntroduction() => "对特定 Property 采用 Unity 原生绘制";
        ...
        protected override string GetOriginalCode() => ReadCodeWithoutNamespace(typeof(DrawWithUnityExample));
    }
}
