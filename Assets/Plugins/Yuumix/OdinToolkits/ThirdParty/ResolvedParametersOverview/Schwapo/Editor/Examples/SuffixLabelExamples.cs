...
namespace YOGA.Modules.OdinToolkits.Schwapo.Editor.Examples
{
    ...
    public class SuffixLabelExamples_Label
    {
        ...
        [FoldoutGroup("Attribute Expression Example")] [SuffixLabel("@UseAlternativeLabel ? AlternativeLabel : Label")]
        public string AttributeExpressionExample;

        [FoldoutGroup("Field Name Example")] [SuffixLabel("$Label")]
        public string FieldNameExample;

        public string Label = "Peace, Love & Ducks";

        [FoldoutGroup("Method Name Example")] [SuffixLabel("$GetLabel")]
        public string MethodNameExample;

        [FoldoutGroup("Property Name Example")] [SuffixLabel("$LabelProperty")]
