...
namespace Yuumix.OdinToolkits.Common.InspectorLocalization.GUIWidgets
{
    ...
    [InlineProperty]
    [HideLabel]
    public class LocalizedHeaderWidget
    {
        public LocalizedHeaderWidget(string chineseName, string englishName, string chineseIntroduction = null,
        ...
        [PropertySpace(5)]
        [LocalizedButtonWidgetConfig("切换为英语", "Switch To Chinese", buttonHeight: 22,
