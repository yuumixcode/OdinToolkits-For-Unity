...
{
    internal class TransformTreeView : TreeView
    {
        ...
        static TreeViewItem CreateTreeViewItemForGameObject(GameObject gameObject) =>
            ...
            new TreeViewItem(gameObject.GetInstanceID(), -1, gameObject.name);
        ...
        GameObject GetGameObject(int instanceID) => (GameObject)EditorUtility.InstanceIDToObject(instanceID);
        ...
        protected override void RowGUI(RowGUIArgs args)
        {
            ...
            var isStatic = EditorGUI.Toggle(toggleRect, gameObject.isStatic);
        ...
        protected override void SetupDragAndDrop(SetupDragAndDropArgs args)
        {
            ...
            var objList = new List<UnityObject>(sortedDraggedIDs.Count);
            ...
            var title = objList.Count > 1 ? "<Multiple>" : objList[0].name;
            ...
            if (args.performDrop)
            {
                switch (args.dragAndDropPosition)
                {
                    ...
                    case DragAndDropPosition.BetweenItems:
                        var parent = args.parentItem != null ? GetGameObject(args.parentItem.id).transform : null;
