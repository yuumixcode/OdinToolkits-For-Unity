...
namespace YOGA.OdinToolkits.AnalysisManual.OdinAttributes.Editor
{
    ...
    {
        [FoldoutGroup("无参数使用")] [DisplayAsString]
        public string string1 = "测试部分";

        [FoldoutGroup("fontSize")] [DisplayAsString(12)]
        public string string2 = "测试部分";

        [FoldoutGroup("overflow")] [DisplayAsString(fontSize: 14, overflow: true)]
        public string string3 = "测试部分非常非常非常非常非常非常非常非常非常非常非常非常非常非常非常非常非常非常长";

        [FoldoutGroup("enableRichText")] [DisplayAsString(14, true)]
        public string string4 = "<color = red>" + "测试部分" + "</color>";

        [FoldoutGroup("alignment")] [DisplayAsString(TextAlignment.Center)]
        ...
        [FoldoutGroup("Format")] [DisplayAsString(Format = "自定义格式化字符串 AAA")]
