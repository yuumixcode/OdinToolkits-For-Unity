...
namespace Yuumix.OdinToolkits.AttributeOverviewPro.Deprecated.Editor
{
    public class ListDrawerSettingsContainer : OdinAttributeContainerSO
    {
            ...
            new List<ParameterValue>
            {
                ...
                new ParameterValue
                {
                    ...
                    ParameterDescription =
                        "自定义删除元素的方法名，方法参数可选 List<T> list，T value，InspectorProperty property（仅 Editor ）"
                },
                new ParameterValue
                {
                    ReturnType = "string",
                    ...
                    ParameterDescription =
                        "自定义移除序号的方法名，方法参数可选 List<T> list，int index，InspectorProperty property（仅 Editor ）"
                },
                new ParameterValue
                {
                    ReturnType = "string",
        ...
        protected override string GetOriginalCode() =>
            ReadCodeWithoutNamespace(typeof(ListDrawerSettingsExample));
    }
}
