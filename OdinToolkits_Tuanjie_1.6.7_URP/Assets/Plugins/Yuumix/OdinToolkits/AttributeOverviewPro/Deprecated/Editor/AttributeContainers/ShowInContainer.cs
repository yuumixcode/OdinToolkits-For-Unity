...
{
    public class ShowInContainer : OdinAttributeContainerSO
    {
        protected override string GetHeader() => "ShowIn";

        protected override string GetIntroduction() => "针对 Prefab 物体对象中的 Property 的 ShowIf 的特殊版本";
        ...
        protected override string GetOriginalCode() => ReadCodeWithoutNamespace(typeof(ShowInExample));
    }
}
