...
namespace Yuumix.OdinToolkits.Core.Editor
{
    ...
    /// </summary>
    public class OdinSyntaxHighlighterSO : OdinEditorScriptableSingleton<OdinSyntaxHighlighterSO>
    {
...
public class Example : ScriptableObject
{
    ...
    public Dictionary<string, int> ExampleDictionary;       
        ...
        [HideInInspector]
        public List<CustomSyntaxHighlighterColorGroup> customColorGroups =
            new List<CustomSyntaxHighlighterColorGroup>();
