...
namespace Yuumix.OdinToolkits.AttributeOverviewPro.Deprecated.Editor
{
    ...
    public class DictionaryDrawerSettingsExample : ExampleOdinSO
    {
        ...
        [PropertyOrder(1)]
        [FoldoutGroup("DictionaryDrawerSettings 基础使用")]
        [InfoBox("修改 KeyLabel 和 ValueLabel，设置 KeyColumnWidth = 50（无效），" + "默认的 DisplayMode 为 OneLine")]
        ...
        [PropertyOrder(20)]
        [FoldoutGroup("DictionaryDrawerSettings 基础使用")]
        [InfoBox("设置 IsReadOnly = true，不能在面板上修改字典的元素数量和字典结构，" + "可以通过代码修改，同时可以在面板上修改具体元素内部的 Property")]
