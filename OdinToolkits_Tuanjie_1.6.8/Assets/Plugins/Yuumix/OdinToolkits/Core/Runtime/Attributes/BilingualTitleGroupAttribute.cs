...
namespace Yuumix.OdinToolkits.Core
{
    ...
    {
        public BilingualTitleGroupAttribute(string groupId, string chineseTitle, string englishTitle = null,
            ...
            bool boldTitle = true, bool indent = false, float order = 0) : base(groupId, order)
        {
