...
{
    [Summary("双语 Button 特性，依赖并兼容 Odin Inspector 的绘制系统。")]
    ...
    public class BilingualButtonAttribute : ShowInInspectorAttribute
    {
        public BilingualButtonAttribute(string chineseName, string englishName = null,
            ...
            int buttonHeight = -1, bool stretch = true, bool drawResult = true, bool expanded = false,
            float buttonAlignment = 0.5f, bool displayParameters = true, bool dirtyOnClick = true)
        {
        ...
        /// <summary>
        /// Whether the containing object or scene (if there is one) should be marked dirty when the button is clicked.
        /// True by
        /// default. Note that if this is false, undo for any changes caused by the button click is also disabled, as
        /// registering
        ...
        /// <summary>
        ///     <para>
        ///     Whether to display the button method's parameters (if any) as values in the inspector. True by
        ///     default.
        ///     </para>
        ///     <para>
        ///     If this is set to false, the button method will instead be invoked through an ActionResolver or
        ///     ValueResolver
        ///     (based on whether it returns a value), giving access to contextual named parameter values like
        ///     "InspectorProperty
